---
title: "Geomarket Analysis of KC for Location of Gas Stations"
output: html_document
---

```{r setup, include=FALSE}
# to knit to  html file
# ------------------------------------
# output: html_document
knitr::opts_chunk$set(echo = TRUE)
tmap_interactive_viewing_mode = "view"

# # # to knit for GitHub repo
# # ------------------------------------
# #output: github_document
# 
# knitr::opts_chunk$set(
#   echo = TRUE,
#   fig.path = "md-figures/geomarket-analysis-"
#   )
# tmap_interactive_viewing_mode = "plot"
```
...
Vehicle Density (kcmva_tract_prjd$vehicle_density)

* from Census variable (B08015_001)
